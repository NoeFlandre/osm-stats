...
single Markdown report to ``output/pipeline_comparison.md``.
...
TFIDF_PROFILE = Path("output/cluster_profile.md")
TFIDF_MEDOIDS = Path("output/cluster_medoids.csv")
EMBED_PROFILE = Path("output/cluster_profile_embeddings.md")
EMBED_MEDOIDS = Path("output/cluster_medoids_embeddings.csv")
COMPARISON_OUT = Path("output/pipeline_comparison.md")
