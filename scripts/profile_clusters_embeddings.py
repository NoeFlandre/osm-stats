...
clobbering each other's artifacts:
    ...
    TF-IDF   :  output/cluster_profile.md
                output/cluster_medoids.csv
                output/env_agri_breakdown.md
    Embedding:  output/cluster_profile_embeddings.md
                output/cluster_medoids_embeddings.csv
                output/env_agri_breakdown_embeddings.md
